...
function setMenuItems(myAvatar) {
    ...
    if (myAvatar.actor.service("PlayerManager").presentationMode) {
        label.textContent = _("Stop Gathering");
    } else {
        label.textContent = _("Gather");
    }
